...
| :--- | :--- | :--- |
| **Interface Roughness** | 0.30 - 0.40 nm RMS | **< 0.18 nm RMS** |
| **Peak Reflectivity** | 65% - 68% | **> 70%** |
| **Stress Build-up** | > 500 MPa (Tensile) | **< 300 MPa** |
| **Thermal Stability** | Degrades > 5% @ 100°C | **Stable > 10k hrs @ 120°C** |
...
| 指标 | 人类基线 (60分) | 本方案 (90分) |
| :--- | :--- | :--- |
| **界面粗糙度** | 0.30 - 0.40 nm RMS | **< 0.18 nm RMS** |
| **峰值反射率** | 65% - 68% | **> 70%** |
| **应力累积** | > 500 MPa（张应力） | **< 300 MPa** |
| **热稳定性** | 100°C下衰减 > 5% | **120°C下>10k小时稳定** |
...
| :--- | :--- | :--- |
| **Grenzflächenrauheit** | 0,30 - 0,40 nm RMS | **< 0,18 nm RMS** |
| **Spitzenreflektivität** | 65% - 68% | **> 70%** |
| **Spannungsaufbau** | > 500 MPa (Zug) | **< 300 MPa** |
| **Thermostabilität** | Abbau > 5% @ 100°C | **Stabil > 10k Std. @ 120°C** |
